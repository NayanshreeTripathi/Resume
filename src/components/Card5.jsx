...
function Card5() {
    ...
    return (
        <div className='m-5'>
            <div 
                className='bg-[#DBE2F299] relative border-2 border-spacing-1 rounded-sm w-[85vw] h-[45vh] md:w-[60vw] md:h-[45vh] lg:w-[35vw] xl:w-[22vw] xl:h-[45vh] sm:w-[65vw] sm:h-[45vh]'
                style={{ border: '2px dotted grey' }}
            >
                <div>
                    <p className='absolute text-xl font-bold  top-[40%] left-[26%] 2xl:left-[30%] xl:left-[30%] md:left-[40%]'>
                        Job Description
                    </p>
                    <p className='absolute text-sm top-[50%] xl:left-[10%] left-[14%] 2xl:left-[17%] md:left-[30%]'>
                        Paste or type the job description here
                    </p>
                </div>
                <div 
                    className='bg-[#FAFBFD] w-[53vw] sm:w-[25vw] md:w-[20vw] lg:w-[13vw] rounded-3xl absolute left-[20%] sm:left-[25%] md:left-[33%] lg:left-[15%] flex items-center top-[60%] h-[7vh] p-1 cursor-pointer'
                    onClick={openModal}
                >
                    <div className='m-2'>
                    ...
                    <div className='px-3 md:px-4 text-sm md:text-base'>
                        Add Description
                    </div>
                </div>
                ...
                {isModalOpen && (
                    <div className='fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50'>
                        <div className='bg-white p-8 rounded-lg shadow-lg z-60 w-[80vw] sm:w-[60vw] md:w-[50vw] lg:w-[40vw] xl:w-[30vw]'>
