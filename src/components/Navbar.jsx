...
function Navbar() {
  ...
  return (
    <>
      <div className='border-b-2 fixed top-0 right-0 left-0 z-50 flex justify-between px-4 md:px-10 w-screen h-[64px] pt-2 bg-white'>
        <div>
          <h1 className='font-bold text-xl md:text-2xl ml-4 md:ml-20 mt-[4%]'>Resume.ai</h1>
        </div>
