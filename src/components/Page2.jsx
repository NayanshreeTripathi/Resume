      ...
      <div className="bg-[#DBE2F2B2] w-screen h-full p-3 py-16 xl:py-13 lg:p-20">
        <div className="pl-[4%] lg:pl-[15%]">
          ...
          <div className="pr-[3%] lg:pr-[44%]">
            <p className="font-normal lg:text-xl mt-[2%]">
            ...
            <p className="font-normal lg:text-xl mt-[2%]">
              Highlights your relevant skills and experiences. Helps you stand
              out from other candidates. Shows that you are a professional who
              takes their career seriously.
            </p>
          </div>
        </div>
